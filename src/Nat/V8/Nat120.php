...
use Bdt\Avetmiss\Config\V8 as Config;

/**
 * Fieldset for the AVETMISS V8 Nat120
 *
    ...
    public function __construct()
    {
        parent::__construct(
            [
                ...
                Field::make('numeric')->name('delivery_mode_id')->length(3),
                ...
                Field::make('any')->name('school_type_indentifier')->length(2),
                ...
                Field::make('any')->name('fee_exemption_concession_type_id')->length(2),
                ...
                Field::make('any')->name('predominant_delivery_mode')->length(1),
